...
어느 날 짓궂은 동주가 지원이의 공부를 방해하기 위해 0이
쓰여진 낱장의 타일들을 붙여서 한 쌍으로 이루어진 00 타일들을 만들었다. 
...
(01, 10은 만들 수 없게 되었다.) 
또한 N = 4일 때는 0011, 0000, 1001, 1100, 1111 등 총 5개의 
2진 수열을 만들 수 있다.
...
def fib_dp(n):
    ...
    for i in range(3, n+1):
        num = (fib_array[i-2]+fib_array[i-1]) % 15746
        fib_array.append(num)

    return print(fib_array[n] % 15746)
